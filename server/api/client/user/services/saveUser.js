                        ...
                        return saveUserQuery(userObj)
                            .then(() => {
                                ...
                                jsonwebtoken.sign({ id: userId }, privateKey, {
                                    ...
                                    sendEmail(email, {
                                        subject: 'Спасибо за регистрацию на платформе ООО "Финансовые Услуги"',
                                        content: templateEmail(
                                            name,
                                            surname,
                                            { header: 'Спасибо за регистрацию', body: 'Спасибо за регистрацию на платформе ООО ООО "Финансовые Услуги"' },
                                            token
                                        )
                                    });
                                });
